...
class ArchVizPage extends React.Component {
    state = {
        photoIndex: 0,
        isOpen: false,
        images: [
        ...
        return (
            <MDBContainer className="mt-5 p-3" style={{ backgroundColor: "#fff" }}>
                ...
                <p className='section-description mt-5 pt-2'>
                    Here are a list of some of my web development projects, mostly full stack but I give utmost importance to the UI/UX aspect to keep my app intersting to my prospective users.
                 </p>
